...
Contributors: destio
Donate link: http://www.typomedia.org/wordpress/plugins/wordpress-meta-keywords/
Tags: crawler, meta elements, meta keywords, meta tags, search engine, search index, seo, spiders
...
* [Homepage](http://www.typomedia.org/wordpress/plugins/wordpress-meta-keywords/ "Homepage of WordPress Meta Keywords")
* [Changelog](http://wordpress.org/extend/plugins/wordpress-meta-keywords/changelog/ "Changelog for WordPress Meta Keywords")
* [Questions](http://wordpress.org/extend/plugins/wordpress-meta-keywords/faq/ "FAQ for WordPress Meta Keywords")

**Localization**

* German translation by [Designstudio, Philipp Speck](http://www.destio.de/ "Designstudio, Philipp Speck")
* Slovak translation by Branco Radenovich
...
1. Upload or choose `wordpress-meta-keywords.zip` from 'Install Plugins'
...
= 1.3 =
* Language support and showing `keywords` on page table view
